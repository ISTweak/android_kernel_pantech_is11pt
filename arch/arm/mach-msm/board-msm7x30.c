...
#ifdef CONFIG_WIFI_CONTROL_FUNC // 20110223 khlee_wifi for wifi platform device 
#include <linux/wlan_plat.h>
#endif

// 20110217 khlee_wifi for getting mac address 
#ifdef CONFIG_PANTECH_WIFI_MAC_ADDR
#include <mach/rpc_nv.h>
#define NV_WLAN_MAC_ADDRESS_I 4678
#define ETHER_ADDR_LEN 6

#ifdef CONFIG_PANTECH_WIFI_RAND_MAC
#include <linux/random.h>
#endif // CONFIG_PANTECH_WIFI_RAND_MAC
...
//by jhsong for fab2200 subsystem at 20110126
#ifdef CONFIG_PANTECH_AUDIO_FAB2200   //20110428 jhsong : feature clearup
#define CONFIG_SND_FAB_SUBSYSTEM   

#if defined(CONFIG_MACH_MSM8X55_MINI) //20110126 jhsong .
#include "./qdsp5v2/snd_sub_fab2200_mini.h"
#elif defined (CONFIG_MACH_MSM8X55_LASER2)
#include "./qdsp5v2/snd_sub_fab2200_laser2.h"
#elif defined (CONFIG_MACH_MSM8X55_J_MASAI_E)
#include "./qdsp5v2/snd_sub_fab2200_masai_e.h"
#endif

#endif

#ifdef CONFIG_SND_FAB_SUBSYSTEM  //20110126 jhsong
#define AUDIO_I2C_SCL		                                 175
#define AUDIO_I2C_SDA		                                 176
static struct i2c_gpio_platform_data i2c_gpio_audio_data = {
	.scl_pin = AUDIO_I2C_SCL,
	.sda_pin = AUDIO_I2C_SDA,
	.udelay = 5,
};

struct platform_device msm_i2c_gpio_audio_device = {
	.name = "i2c-gpio",
	.id = 5,
	.dev	= {
...
#endif /*CONFIG_SND_FAB_SUBSYSTEM*/

#if defined(CONFIG_PANTECH_MINI_AUDIO_AUDIENCE1028)
#include "./qdsp5v2/snd_audience_a1028_mini.h"
#elif defined(CONFIG_PANTECH_LASER2_AUDIENCE2020)
#include "./qdsp5v2/snd_audience_a2020_laser2.h"
#else
#endif
...
#define I2C_SCL_AUDIENCE	67  
#define I2C_SDA_AUDIENCE	65  
...
static struct i2c_board_info i2c_audience_nr[] = {
	{
		I2C_BOARD_INFO("audience-a1028", 	A1028_SLAVE_ADDR),
	}
};
...
//sghong [
#define CONFIG_SENSOR_I2C_GPIO
//]
#ifdef CONFIG_SENSOR_I2C_GPIO

#define GPIO_M_SENSOR_SCL 178
#define GPIO_M_SENSOR_SDA 126
#define GPIO_M_GMS_RESET_N	177
#define GPIO_M_GMS_INT_GPO	114


#define GPIO_G_SENSOR_SCL 128
#define GPIO_G_SENSOR_SDA 129
#define GPIO_G_G_INT 180

#define GPIO_P_SENSOR_SCL 38
#define GPIO_P_SENSOR_SDA 39
#define GPIO_P_PROX_INT 42

#if 1
static uint32_t sensor_gpio_table[] = {
	GPIO_CFG(GPIO_M_SENSOR_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),
	GPIO_CFG(GPIO_M_SENSOR_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),

#if defined(CONFIG_MACH_MSM8X55_J_MASAI_E)
#if (BOARD_VER == WS10 )
	//do not control 128 gpio GPIO_G_SENSOR_SCL
#else
	GPIO_CFG(GPIO_G_SENSOR_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),
#endif
#elif defined(CONFIG_MACH_MSM8X55_MINI)
	GPIO_CFG(GPIO_G_SENSOR_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),
#endif	
	GPIO_CFG(GPIO_G_SENSOR_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),

	
	GPIO_CFG(GPIO_G_SENSOR_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),

	GPIO_CFG(GPIO_P_SENSOR_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),
	GPIO_CFG(GPIO_P_SENSOR_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ),

	GPIO_CFG(GPIO_M_GMS_RESET_N, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ), //GMS_RESET_N
	GPIO_CFG(GPIO_M_GMS_INT_GPO, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA ), //GMS_INT
	GPIO_CFG(GPIO_G_G_INT, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA ), //G_INT
	GPIO_CFG(GPIO_P_PROX_INT, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA ), //PROX_INT
};
#endif

static struct i2c_gpio_platform_data i2c_gpio_m_sensor_data = {
    .scl_pin = GPIO_M_SENSOR_SCL,
    .sda_pin = GPIO_M_SENSOR_SDA,
    .udelay = 2,
};

static struct i2c_gpio_platform_data i2c_gpio_g_sensor_data = {
    .scl_pin = GPIO_G_SENSOR_SCL,
    .sda_pin = GPIO_G_SENSOR_SDA,
    .udelay = 2,
};

static struct i2c_gpio_platform_data i2c_gpio_p_sensor_data = {
    .scl_pin = GPIO_P_SENSOR_SCL,
    .sda_pin = GPIO_P_SENSOR_SDA,
    .udelay = 2,
};

struct platform_device msm_device_i2c_gpio_m_sensor = {
    .name = "i2c-gpio",
    .id = 10,
    .dev = {
        .platform_data = &i2c_gpio_m_sensor_data,
    }
};

struct platform_device msm_device_i2c_gpio_g_sensor = {
    .name = "i2c-gpio",
    .id = 11,
    .dev = {
        .platform_data = &i2c_gpio_g_sensor_data,
    }
};

struct platform_device msm_device_i2c_gpio_p_sensor = {
    .name = "i2c-gpio",
    .id = 12,
    .dev = {
        .platform_data = &i2c_gpio_p_sensor_data,
    }
};

static struct i2c_board_info m_sensor_board_info[] = {
	{
		I2C_BOARD_INFO("geomagnetic", 0x2E),		// magneticfield sensor
	},	
};

static struct i2c_board_info g_sensor_board_info[] = {
	{
		I2C_BOARD_INFO("accelerometer", 0x38),		// accelerometer sensor
	},	
};

static struct i2c_board_info p_sensor_board_info[] = {
	{
		I2C_BOARD_INFO("apds9190", 0x39),	// proximity sensor
	},	
};
#endif //CONFIG_SENSOR_I2C_GPIO
#if defined(CONFIG_MACH_MSM8X55_LASER2) && (BOARD_VER == WS10)	// TOUCH_USES_I2C_CONTROL
...
#endif /* TOUCH_USES_I2C_CONTROL */

#if defined(CONFIG_MACH_MSM8X55_MINI) || defined(CONFIG_MACH_MSM8X55_J_MASAI_E) || defined(CONFIG_MACH_MSM8X55_LASER2)  
#define MSM_PMEM_SF_SIZE	0x2E00000 //shinbrad shinjg 20110418 
#else
...
//#if defined(CONFIG_MACH_MSM8X55_LASER2)
#define MSM_GPIO_SD_DET 44
//#endif /* CONFIG_MACH_MSM8X55_LASER2 */

#if defined(CONFIG_MACH_MSM8X55_MINI) || defined(CONFIG_MACH_MSM8X55_J_MASAI_E)
#if (BOARD_VER >= WS10)
#define PMIC_GPIO_SDC4_EN_N    24  /* PMIC GPIO Number 25 */
#else
#define PMIC_GPIO_SDC4_EN_N    30  /* PMIC GPIO Number 31 */
...
#ifdef CONFIG_MMC_MSM_CARD_HW_DETECTION
	if (machine_is_msm7x30_fluid() || machine_is_msm8x55_mini() || machine_is_msm8x55_j_masai_e() || machine_is_msm8x55_laser2()){
...
static const unsigned int mini_keymap[] = {
  #if (BOARD_VER <= WS10)  
  KEY(0, 0, KEY_BACK),
  #else
  KEY(0, 0, KEY_MENU),
...
static const unsigned int j_masai_e_keymap[] = {
#if (BOARD_VER <= PT10) 
  KEY(0, 0, KEY_BACK),
  KEY(0, 1, KEY_VOLUMEDOWN),
  KEY(0, 2, KEY_VOLUMEUP),
...
static const unsigned int laser2_keymap[] = {
	KEY(0, 0, KEY_Q),
	KEY(0, 1, KEY_A),
	KEY(0, 2, KEY_G),
	KEY(0, 3, KEY_C),
...
static struct matrix_keymap_data mini_keymap_data = {
        .keymap_size    = ARRAY_SIZE(mini_keymap),
        .keymap         = mini_keymap,
};

static struct pmic8058_keypad_data mini_keypad_data = {
	.input_name		= "surf_keypad",
	.input_phys_device	= "surf_keypad/input0",
	.num_rows		= 5,
	.num_cols		= 5,
	...
	.row_hold_ns		= 91500,
	.wakeup			= 1,
	.keymap_data            = &mini_keymap_data,
};

static struct matrix_keymap_data j_masai_e_keymap_data = {
        .keymap_size    = ARRAY_SIZE(j_masai_e_keymap),
        .keymap         = j_masai_e_keymap,
};

static struct pmic8058_keypad_data j_masai_e_keypad_data = {
	.input_name		= "surf_keypad",
	.input_phys_device	= "surf_keypad/input0",
	.num_rows		= 5,
	.num_cols		= 5,
	...
	.row_hold_ns		= 91500,
	.wakeup			= 1,
	.keymap_data            = &j_masai_e_keymap_data,
};

static struct matrix_keymap_data laser2_keymap_data = {
        .keymap_size    = ARRAY_SIZE(laser2_keymap),
        .keymap         = laser2_keymap,
};
static struct pmic8058_keypad_data laser2_keypad_data = {
	.input_name		= "surf_keypad",
	.input_phys_device	= "surf_keypad/input0",
	.num_rows		= 7,
	.num_cols		= 6,
	...
	.row_hold_ns		= 91500,
	.wakeup			= 1,
	.keymap_data            = &laser2_keymap_data,
};
#ifdef CONFIG_PMIC8058_VIBRATOR
...
static struct pmic8058_led pmic8058_mini_leds[] = {
	[0] = {
...
static struct pmic8058_led pmic8058_laser2_leds[] = {
	[0] = {
		.name		= "button-backlight",
		.max_brightness = 5,
		.id		= PMIC8058_ID_LED_0,
...
static struct pmic8058_led pmic8058_j_masai_e_leds[] = {
	[0] = {
		.name		= "button-backlight",
		.max_brightness = 15,
		.id		= PMIC8058_ID_LED_KB_LIGHT,
...
static struct pmic8058_leds_platform_data pm8058_mini_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_mini_leds),
	.leds	= pmic8058_mini_leds,
};

static struct pmic8058_leds_platform_data pm8058_laser2_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_laser2_leds),
	.leds	= pmic8058_laser2_leds,
};

static struct pmic8058_leds_platform_data pm8058_j_masai_e_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_j_masai_e_leds),
	.leds	= pmic8058_j_masai_e_leds,
};
...
#endif
#if defined(CONFIG_YACE4B1SBDBS)
{
		I2C_BOARD_INFO("yace4b1sbdbs", 0x40 >> 1 ),
},
#endif
};
...
#if defined(CONFIG_MACH_MSM8X55_J_MASAI_E) && (BOARD_VER >= WS10)
	GPIO_CFG(33, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /* FLASH */
#endif
	GPIO_CFG(43, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /* LDO_EN */
	GPIO_CFG(121, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /* RESET */
	GPIO_CFG(123, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /* STB */
#else
...
#ifdef CONFIG_YACE4B1SBDBS
static struct msm_camera_sensor_flash_data flash_yace4b1sbdbs = {
	.flash_type = MSM_CAMERA_FLASH_NONE,
	.flash_src  = &msm_flash_src_pwm
};

static struct msm_camera_sensor_info msm_camera_sensor_yace4b1sbdbs_data = {
	.sensor_name    = "yace4b1sbdbs",
	.sensor_reset   = 121,
	.sensor_pwd     = 0,
	.vcm_pwd        = 0,
	.vcm_enable     = 0,
	...
	.resource       = msm_camera_resources,
	.num_resources  = ARRAY_SIZE(msm_camera_resources),
	.flash_data     = &flash_yace4b1sbdbs,
	.csi_if         = 0
};

static struct platform_device msm_camera_sensor_yace4b1sbdbs = {
	.name      = "msm_camera_yace4b1sbdbs",
	.dev       = {
		.platform_data = &msm_camera_sensor_yace4b1sbdbs_data,
	},
};
#endif
...
#ifndef CONFIG_SND_FAB_SUBSYSTEM  //20110126 jhsong 
...
#if defined(CONFIG_PANTECH_MINI_AUDIO_AUDIENCE1028)
#define GPIO_MIC_SEL_SEL 		69 	// jmlee pull down   		0 : A1028, 1 : QTR
#define GPIO_NR_AMP_EN 			84 	// jmlee pull down     	0 : amp off, 1 : amp on
#define GPIO_NR_OUT_SEL 		85 	// jmlee pull up       		0 : A1028+Speaker,QTR Receiver  //  1 : A1028+Reciever, 

static uint32_t audio_mic_sel_switch_gpio_config =
   GPIO_CFG(GPIO_MIC_SEL_SEL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA);
static uint32_t audio_nr_receiver_amp_gpio_config =
   GPIO_CFG(GPIO_NR_AMP_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA);
static uint32_t audio_nr_out_sel_switch_gpio_config =
   GPIO_CFG(GPIO_NR_OUT_SEL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA);

static int __init snddev_PAN_audio_gpio_init(void)
{
	int rc;

	pr_info("snddev_PAN_audio_gpio_init start ===>> \n");
	rc = gpio_tlmm_config(audio_mic_sel_switch_gpio_config, GPIO_CFG_ENABLE);
	if (rc) {
		printk(KERN_ERR
			"%s: gpio_tlmm_config(%#x)=%d\n",
			__func__, audio_mic_sel_switch_gpio_config, rc);
		return rc;
	}
	rc = gpio_tlmm_config(audio_nr_out_sel_switch_gpio_config, GPIO_CFG_ENABLE);
	if (rc) {
		printk(KERN_ERR
			"%s: gpio_tlmm_config(%#x)=%d\n",
			__func__, audio_nr_out_sel_switch_gpio_config, rc);
		return rc;
	}
	rc = gpio_tlmm_config(audio_nr_receiver_amp_gpio_config, GPIO_CFG_ENABLE);
	if (rc) {
		printk(KERN_ERR
			"%s: gpio_tlmm_config(%#x)=%d\n",
			__func__, audio_nr_receiver_amp_gpio_config, rc);
		return rc;
	}
	pr_info("snddev_PAN_audio_gpio_init SUCCESS ~~~!!!  \n");
	return rc;
}

void msm_snddev_mic_sel_a1028(void)
{
	gpio_set_value(GPIO_MIC_SEL_SEL, 0);	
	pr_info("%s: #@#@#@#@#@#@#@#@# mic selection A1028\n", __func__);
}
void msm_snddev_mic_sel_QTR(void)
{
	gpio_set_value(GPIO_MIC_SEL_SEL, 1);	
	pr_info("%s: #@#@#@#@#@#@#@#@# mic selection QTR\n", __func__);
}
void msm_snddev_nr_receiver_amp_on(void)
{
	gpio_set_value(GPIO_NR_AMP_EN, 1);	
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_receiver_amp_on\n", __func__);
}
void msm_snddev_nr_receiver_amp_off(void)
{
	gpio_set_value(GPIO_NR_AMP_EN, 0);	
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_receiver_amp_off\n", __func__);
}
void msm_snddev_nr_out_sel_qtrReceiver_or_A1028Speaker(void)
{
//	gpio_set_value(GPIO_NR_OUT_SEL, 1);	
	gpio_set_value(GPIO_NR_OUT_SEL, 0);	//20110223 jhsong	
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_out_sel_qtrReceiver_or_A1028Speaker\n", __func__);
}
void msm_snddev_nr_out_sel_A1028Reciever(void)
{
//	gpio_set_value(GPIO_NR_OUT_SEL, 0);	
	gpio_set_value(GPIO_NR_OUT_SEL, 1);	//20110223 jhsong	
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_out_sel_A1028Reciever\n", __func__);
}
void msm_snddev_nr_out_sel_A1028Reciever_nr_receiver_amp_on(void)
{
//	gpio_set_value(GPIO_NR_OUT_SEL, 0);	
	gpio_set_value(GPIO_NR_OUT_SEL, 1);	//20110223 jhsong
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_out_sel_A1028Reciever\n", __func__);
...
void msm_snddev_nr_out_sel_A1028Reciever_nr_receiver_amp_off(void)
{
//	gpio_set_value(GPIO_NR_OUT_SEL, 0);	
	gpio_set_value(GPIO_NR_OUT_SEL, 1);	//20110223 jhsong	
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_out_sel_A1028Reciever\n", __func__);
...
#elif defined(CONFIG_PANTECH_LASER2_AUDIENCE2020)
#define GPIO_MIC_SEL_SEL 		69 // jmlee pull down   	0 : A2020, 1 : QTR
#define GPIO_NR_AMP_EN 			84 // jmlee pull down     0 : amp off, 1 : amp on
#define GPIO_NR_OUT_SEL 		82
...
void msm_snddev_nr_out_sel_qtrReceiver_or_A2020Speaker(void)
{
//	gpio_set_value(GPIO_NR_OUT_SEL, 1);	
	gpio_set_value(GPIO_NR_OUT_SEL, 0);	//20110223 jhsong	
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_out_sel_qtrReceiver_or_A1028Speaker\n", __func__);
...
void msm_snddev_nr_out_sel_A2020Reciever_nr_receiver_amp_on(void)
{
//	gpio_set_value(GPIO_NR_OUT_SEL, 0);	
	gpio_set_value(GPIO_NR_OUT_SEL, 1);	//20110223 jhsong
	pr_info("%s: #@#@#@#@#@#@#@#@# nr_out_sel_A1028Reciever\n", __func__);
...
static int __init buses_init(void)
{
	...
	} else if (machine_is_msm8x55_mini()) {
	  pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].platform_data
			= &mini_keypad_data;
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].data_size
			= sizeof(mini_keypad_data);
	} else if (machine_is_msm8x55_j_masai_e()) {
	  pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].platform_data
			= &j_masai_e_keypad_data;
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].data_size
			= sizeof(j_masai_e_keypad_data);
	} else if(machine_is_msm8x55_laser2()) {
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].platform_data
			= &laser2_keypad_data;
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].data_size
			= sizeof(laser2_keypad_data);
	} else {
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].platform_data
			= &surf_keypad_data;
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_KPD].data_size
...
#if defined(CONFIG_SND_FAB_SUBSYSTEM)  //20110704 jhsong : compile error
int bahama_present(void)
{
	int id;
...
//by jhsong for fab2200 subsystem at 20110126
#ifndef CONFIG_SND_FAB_SUBSYSTEM  // GPIO 147 is NR_WAKEUP_N
...
//by jhsong for fab2200 subsystem at 20110126
#ifdef CONFIG_SND_FAB_SUBSYSTEM  // GPIO 147 is NR_WAKEUP_N
	.fm = NULL,
#else
	.fm = &marimba_fm_pdata,
#endif	
...
#ifndef CONFIG_MARIMBA_CODEC  //20110516 jhsong : timpani reset gpio & touch i2c sda gpio same
...
//by jhsong for fab2200 subsystem at 20110126
#ifdef CONFIG_SND_FAB_SUBSYSTEM
static struct i2c_board_info msm_audio_i2c_board_info[] = {
	{
...
static char *usb_pantech_functions_default[] = {
	"modem",
	"diag",
	"usb_mass_storage",
	"obex", 
};
static char *usb_pantech_functions_default_adb[] = {
	"modem",
	"diag",
	"usb_mass_storage",
	"adb",
...
static char *usb_functions_all[] = {
	...
	"rndis",
#endif
	"usb_mass_storage", //msy_usb no USB driver for UMS
	...
	"rmnet",
#endif
#if 0 //msy_usb no USB driver for UMS
	"usb_mass_storage",
#endif	
...
static struct android_usb_product usb_products[] = {
	...
	{
		.product_id	    = 0x6011,
		.num_functions = ARRAY_SIZE(usb_pantech_functions_default),
		.functions = usb_pantech_functions_default,
	},
	{
		.product_id	    = 0x6011,
		.num_functions = ARRAY_SIZE(usb_pantech_functions_default_adb),
		.functions = usb_pantech_functions_default_adb,
	},	
#endif
	{
		.product_id     = 0x9026,
...
#ifdef  CONFIG_PANTECH_USB /* RNDIS*/
	{
		/* RNDIS + DIAG */
		.product_id     = 0x6013,
...
#if defined(CONFIG_MACH_MSM8X55_MINI)
		.product_id 	= 0x6019,  //msy_20110610 0x6015 -> 0x6019
#elif defined (CONFIG_MACH_MSM8X55_LASER2)
		.product_id 	= 0x6016,	//p13120 @ LDH. 0x6015 -> 0x6016
#else
		.product_id 	= 0x6015,
#endif	
...
static struct usb_mass_storage_platform_data mass_storage_pdata = {
	.nluns		= 1,
#ifdef CONFIG_PANTECH_USB //msy_usb 
	.vendor		= "Pantech ",
#else
...
//20110127 jjangu_device for touch
#if defined(CONFIG_MACH_MSM8X55_MINI) || defined(CONFIG_MACH_MSM8X55_J_MASAI_E)  || ( defined(CONFIG_MACH_MSM8X55_LASER2) && (BOARD_VER >= WS20)) 
	{
...
#if defined(CONFIG_MACH_MSM8X55_LASER2) && (BOARD_VER == WS10)
...
#ifdef CONFIG_PANTECH_MINI_HDRADIO
static struct spi_board_info radio_siport_sp20xx_spi_board_info[] __initdata = {
{
                .modalias       = "radio_siport_sp20xx",
                .mode           = SPI_MODE_0,
                .bus_num        = 0,
                .chip_select    = 1,
...
#if defined(CONFIG_MACH_MSM8X55_MINI)
#ifdef CONFIG_PANTECH_MINI_HDRADIO
	{ GPIO_CFG(44, 1, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "spi_cs1" },	 // jmlee HD Radio CS	
#endif
#endif
...
#if defined(CONFIG_USB_GADGET) && defined(CONFIG_USB_MSM_OTG_72K)
...
#else
	struct vreg *vreg_ldo16;
#endif
	struct vreg *vreg_ldo20_touch, *vreg_ldo8 = NULL;
...
//20110127 jjangu_device for touch , we used touch power for mini model.
	/* 2.6V -- LDO16 */
            if(machine_is_msm8x55_surf()){
                #if (BOARD_VER == PT10)
	            vreg_ldo20_touch = vreg_get(NULL, "gp10");
                #else
                vreg_ldo20_touch = vreg_get(NULL, "gp13");
                #endif

	            if (IS_ERR(vreg_ldo20_touch)) {/* 2011.03.11 Do. layer1 for compile error*/	
		            rc = PTR_ERR(vreg_ldo20_touch);
	...
	if(machine_is_msm8x55_surf()){/* 2011.03.11 Do. layer1 for machine type*/
#if (BOARD_VER <  WS10)
	if (quickvx_mddi_client)
...
#else
			if (quickvx_mddi_client)
			rc = vreg_set_level(vreg_ldo16, 1800);
		else
			rc = vreg_set_level(vreg_ldo16, 1500);
		if (rc) {
			pr_err("%s: vreg LDO20 set level failed (%d)\n",
			       __func__, rc);
			return rc;
...
//20110127 jjangu_device for touch , we used machine_is_msm8x55_mini
      if(machine_is_msm8x55_surf()){
          #if (BOARD_VER == PT10)
	      rc = vreg_set_level(vreg_ldo20_touch, 2600);
          #else
          rc = vreg_set_level(vreg_ldo20_touch, 3000);
          #endif
	if (rc) {
...
//20110127 jjangu_device for touch
            if(machine_is_msm8x55_surf()){
		      rc = vreg_enable(vreg_ldo20_touch);
		if (rc) {
...
//20110127 jjangu_device for touch
            if(machine_is_msm8x55_surf()){
		      rc = vreg_disable(vreg_ldo20_touch);
...
#ifdef CONFIG_MACH_MSM8X55_LASER2
#define MDDI_RESET	122
#define MDDI_BACKLIGHT	130

#if(BOARD_VER > WS10)
#define MDDI_PMIC_GPIO	43
#endif

static int mddi_display_common_power(int on)
{
	
	int flag_on = !!on;
	int rc;
	static int lcdc_common_power_save_on;
	
#if(BOARD_VER == WS10)
	struct vreg *vreg_ldo3, *vreg_ldo12 = NULL;
#else
	struct vreg *vreg_ldo12 = NULL;
#endif		  

	if (lcdc_common_power_save_on == flag_on)
		return 0;
		  
	lcdc_common_power_save_on = flag_on;
	
	
	////gpio_set_value(MDDI_RESET, 1);
	
#if(BOARD_VER == WS10)
	vreg_ldo3 = vreg_get(NULL, "ruim");
	if (IS_ERR(vreg_ldo3)) {
    	rc = PTR_ERR(vreg_ldo3);
        pr_err("%s: gp6 vreg get failed (%d)\n",
                   __func__, rc);
       	return rc;
	}
...
#if(BOARD_VER == WS10)
	rc = vreg_set_level(vreg_ldo3, 2800); 
    if(rc){
    	pr_err("%s: vreg LD03 set level failed (%d)\n",
                   __func__, rc);
        return rc;
   	}
#endif
	...
	if(on)
	{
    	//gpio_set_value(MDDI_RESET, 0);
#if(BOARD_VER > WS10)
		gpio_set_value(MDDI_PMIC_GPIO, 1);
#endif

#if(BOARD_VER == WS10)
		rc = vreg_enable(vreg_ldo3);
		if(rc){
			pr_err("%s: LDO3 vreg enable failed (%d)\n",
						__func__, rc);
			return rc;
		}
        ...
        //gpio_set_value(MDDI_RESET, 1); 	/* bring reset line high */
        mdelay(10); 					/* 10 msec before IO can be accessed */
		printk(KERN_WARNING "[MDDI_SKY_LCD] %s  POWER_ON \n",__func__);
    }
#if 0
	else
	{
        gpio_set_value(MDDI_RESET, 0);
#if(BOARD_VER > WS10)
		gpio_set_value(MDDI_PMIC_GPIO, 0);
#endif
#if(BOARD_VER == WS10)

		rc = vreg_disable(vreg_ldo3);
		if(rc){
			pr_err("%s: LDO15 vreg enable failed (%d)\n",
						__func__, rc);
			return rc;
		...
		printk(KERN_WARNING " [MDDI_SKY_LCD] %s POWER_OFF \n",__func__);
	}
#endif
	return rc;
}
...
#else
static struct mddi_platform_data mddi_pdata = {
	.mddi_power_save = mddi_display_common_power,
	.mddi_sel_clk = msm_fb_mddi_sel_clk,
};
#endif
...
#if defined(CONFIG_FB_MSM_LCDC_COMMON_PT) || defined(CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA)
static int lcd_common_pt_panel_spi_gpio_num[] = {
#if defined(CONFIG_MACH_MSM8X55_MINI) && (BOARD_VER >= WS10)
                  172, /* spi_cs  */
                  173, /* spi_mosi */
                  174, /* spi_clk */
#else
 ...
 */
//#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT
//#if defined(CONFIG_FB_MSM_LCDC_COMMON_PT) || defined(CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA)
//      { GPIO_CFG(18, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcdc_grn0" },
//#endif
...
//#if defined(CONFIG_FB_MSM_LCDC_COMMON_PT) && !defined(CONFIG_SPI_QSD)
//#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT
//#if defined(CONFIG_FB_MSM_LCDC_COMMON_PT) || defined(CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA)  
#if (BOARD_VER < WS10)
...
#if defined(CONFIG_MACH_MSM8X55_MINI) && (BOARD_VER >= WS10)
    { GPIO_CFG(172, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcdc_spi_cs0" },
    { GPIO_CFG(173, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcdc_spi_mosi" },
    { GPIO_CFG(174, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcdc_spi_clk" },
#endif /* CONFIG_FB_MSM_LCDC_COMMON_PT */
};

//#ifndef CONFIG_FB_MSM_LCDC_COMMON_PT
#if !defined(CONFIG_FB_MSM_LCDC_COMMON_PT) && !defined(CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA)
...
#define LCDC_RESET 122
#define LCDC_BACKLIGHT 130
static struct msm_gpio lcdc_common_control_gpios[] = {
      {GPIO_CFG(LCDC_RESET, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),"lcdc_reset"},
      { GPIO_CFG(LCDC_BACKLIGHT, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcdc_backlight" },
};

static int lcdc_common_pt_power(int on)
{
      int rc = 0, flag_on = !!on;
      static int lcdc_common_power_save_on;
      struct vreg *vreg_ldo12, *vreg_ldo15 = NULL;
      ...
      lcdc_common_power_save_on = flag_on;
       ...
       gpio_set_value(LCDC_RESET, 1);
#endif
      if (on) {

            rc = msm_gpios_enable(lcdc_common_control_gpios,
                              ARRAY_SIZE(lcdc_common_control_gpios));
            if (rc < 0) {
                  printk(KERN_ERR "%s: gpio enable failed: %d\n",
                              __func__, rc);
                  return rc;
...
//#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA
//	    mdelay(20); //shinbrad lcd
//#endif
      }
...
#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA
       rc = vreg_set_level(vreg_ldo15, 2800); // 2.8v schematic modified  2.9 -> 2.8 
       if (rc) {
              pr_err("%s: vreg LDO15 set level failed (%d)\n",
                   __func__, rc);
              return rc;
...
#else
	   rc = vreg_set_level(vreg_ldo15, 3000); // 2.8v schematic modified  2.9 -> 2.8 
	   if (rc) {
			  pr_err("%s: vreg LDO15 set level failed (%d)\n",
					__func__, rc);
			   return rc;
      ...
      if (on) {
#ifdef CONFIG_MACH_MSM8X55_MINI
     		 gpio_set_value(LCDC_RESET, 0);
#endif
//#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA
//			  mdelay(10); //shinbrad lcd
//#endif
            rc = vreg_enable(vreg_ldo12);
            if (rc) {
                  pr_err("%s: LDO12 vreg enable failed (%d)\n",
...
#if defined(CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA) || defined(CONFIG_MACH_MSM8X55_J_MASAI_E)  
            mdelay(10); //shinbrad lcd 
#endif
            rc = vreg_enable(vreg_ldo15);
            if (rc) {
            ...
            mdelay(5);        /* ensure power is stable */
#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA
            mdelay(5);        /* shinbrad lcd 15ms */

            gpio_set_value(LCDC_RESET, 1); /* bring reset line high */
            mdelay(10); /* 10 msec before IO can be accessed */
#endif
            ...
            gpio_set_value(LCDC_RESET, 0); /* bring reset line low */
...
static int lcdc_common_pt_panel_power(int on)
{
      int flag_on = !!on;
      static int lcdc_common_power_save_on;
...
#if defined(CONFIG_FB_MSM_LCDC_COMMON_PT) || defined(CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA)
//#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT
      .lcdc_power_save = lcdc_common_pt_panel_power,
#else
...
//#ifdef CONFIG_FB_MSM_LCDC_COMMON_PT
#if defined(CONFIG_FB_MSM_LCDC_COMMON_PT) || defined(CONFIG_FB_MSM_LCDC_COMMON_PT_SVGA)
static struct msm_panel_common_pdata lcdc_common_pt_panel_data = {
      .gpio_num   = lcd_common_pt_panel_spi_gpio_num,
};

static struct platform_device lcdc_common_pt_panel_device = {
      .name = "lcdc_common_pt",
      .id = 0,
      .dev = {
            .platform_data = &lcdc_common_pt_panel_data,
      }

};
#endif

// 20110126 lhw_device BT init with out-of-band sleep ++++
#ifdef CONFIG_PANTECH_BT
...
#ifdef CONFIG_WIFI_CONTROL_FUNC // 20110223 khlee_wifi for wifi platform device
#ifdef CONFIG_WIFI_MEM_PREALLOC  // 20110223 khlee_wifi for wifi platform device memory pre-alloc
...
// 20110322 khlee_wifi for wifi suspend/resume patch
	/* WLAN_SHDN */
//	GPIO_CFG(GPIO_NO_WLAN_SHDN, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	/* WLAN_HOST_WAKE */
//	GPIO_CFG(GPIO_NO_WLAN_HOST_WAKE, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};
...
#else // 20110223 khlee_wifi : it's probably original codes
	if (on) {
		for (pin = 0; pin < ARRAY_SIZE(wlan_on_gpio_cfgs); pin++) {
			rc = gpio_tlmm_config(wlan_on_gpio_cfgs[pin], GPIO_CFG_ENABLE);
			if (rc) {
		...
		gpio_set_value(GPIO_NO_WLAN_SHDN, on);
		mdelay(10);
		gpio_set_value(GPIO_NO_WLAN_SHDN, 0);
		mdelay(10);
		gpio_set_value(GPIO_NO_WLAN_SHDN, on); 
	} else {
		gpio_set_value(GPIO_NO_WLAN_SHDN, 0);
...
err1:
	if ( ret )
	{
		...
		printk(KERN_INFO "%s : Making radom mac address\n", __FUNCTION__);
			
		// 20110217 khlee_wifi for random wifi mac generation 
		nv_mac.octet[0] = 0x2e;
		nv_mac.octet[1] = 0x30;
		nv_mac.octet[2] = 0x68;
			
		for ( i = 3; i < ETHER_ADDR_LEN; i++ ) {
			get_random_bytes(&nv_mac.octet[i], 1);  
		}

		printk(KERN_INFO "%s : Mac address maked : %.2x:%.2x:%.2x:%.2x:%.2x:%.2x\n", __FUNCTION__, 
				nv_mac.octet[0], nv_mac.octet[1], nv_mac.octet[2],
				nv_mac.octet[3], nv_mac.octet[4], nv_mac.octet[5]);
...
//		.flags		= IORESOURCE_IRQ | IORESOURCE_IRQ_LOWEDGE,
		.flags		= IORESOURCE_IRQ | IORESOURCE_IRQ_LOWLEVEL, // 20110224 khlee_wifi for wifi hw_oob
	},
};
...
static struct platform_device *devices[] __initdata = {
	...
	&msm_device_i2c_2,
	&msm_device_uart_dm1,
// 20110426 EGTAKAGAKI : 20110622 iblee : IrDA Uart2DM Enable
#ifdef CONFIG_MACH_MSM8X55_J_MASAI_E
      &msm_device_uart_dm2,
#else
...
#endif /*CONFIG_MACH_MSM8X55_J_MASAI_E*/
// 20110426 EGTAKAGAKI : 20110622 iblee : IrDA Uart2DM Enable
	&hs_device,
#ifdef CONFIG_MSM7KV2_AUDIO
	&msm_aictl_device,
...
// 20110126 lhw_device BT init ++++
/* #if defined(CONFIG_MARIMBA_CORE) && \  */
#if defined(CONFIG_PANTECH_BT) || (CONFIG_MARIMBA_CORE) && \
   (defined(CONFIG_MSM_BT_POWER) || defined(CONFIG_MSM_BT_POWER_MODULE))
// 20110126 lhw_device BT init ----
	&msm_bt_power_device,
#endif
...
#endif
#if defined(CONFIG_YACE4B1SBDBS)
	&msm_camera_sensor_yace4b1sbdbs,
#endif
...
#ifdef CONFIG_SENSOR_I2C_GPIO
	&msm_device_i2c_gpio_m_sensor,
	&msm_device_i2c_gpio_g_sensor,
	&msm_device_i2c_gpio_p_sensor,
#endif
...
#ifdef CONFIG_WIFI_CONTROL_FUNC // 20110331 khlee_wifi for wifi sleep current 
...
{
    if(machine_is_msm8x55_laser2()){
        return (unsigned int) !(gpio_get_value(MSM_GPIO_SD_DET));
    }
    else{
...
static struct mmc_platform_data msm7x30_sdc3_data = {
...
#ifdef CONFIG_BCM4329_HOSTWAKEUP // 20110209 khlee_wifi for wifi linux gpio settings
	...
	.msmsdcc_fmid	= 24576000,
	.msmsdcc_fmax	= 49152000,
#ifdef CONFIG_WIFI_CONTROL_FUNC // 20110704 khlee_wifi for wifi suspend/resume
	.nonremovable	= 1,
#endif			
};
#endif
...
static void __init msm7x30_init_mmc(void)
{
    ...
    if (machine_is_msm8x55_mini()){
        msm7x30_sdc4_data.ocr_mask |=   MMC_VDD_30_31;
        sdcc_vreg_data[3].level = 3000;
     }

    if (machine_is_msm8x55_j_masai_e()){
        msm7x30_sdc4_data.ocr_mask |=   MMC_VDD_30_31;
        sdcc_vreg_data[3].level = 3000;
     }

    /*
        this section overwrite info for laser2 model
    */

    if(machine_is_msm8x55_laser2()){
        sdcc_vreg_data[3].vreg_data = vreg_gp10;
        msm7x30_sdc4_data.ocr_mask |=   MMC_VDD_30_31;
        sdcc_vreg_data[3].level = 3000;

#ifdef CONFIG_MMC_MSM_CARD_HW_DETECTION
        msm7x30_sdc4_data.status_irq = MSM_GPIO_TO_INT(MSM_GPIO_SD_DET);
...
static void __init pmic8058_leds_init(void)
{
	if (machine_is_msm7x30_surf()) {
	  ...
	  pm8058_7x30_data.sub_devices[PM8058_SUBDEV_LED].platform_data
			= &pm8058_mini_leds_data;
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_LED].data_size
			= sizeof(pm8058_mini_leds_data);
	} else if (machine_is_msm8x55_j_masai_e()) {
	  pm8058_7x30_data.sub_devices[PM8058_SUBDEV_LED].platform_data
			= &pm8058_j_masai_e_leds_data;
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_LED].data_size
			= sizeof(pm8058_j_masai_e_leds_data);
	} else if (machine_is_msm8x55_laser2()) {
	  pm8058_7x30_data.sub_devices[PM8058_SUBDEV_LED].platform_data
			= &pm8058_laser2_leds_data;
		pm8058_7x30_data.sub_devices[PM8058_SUBDEV_LED].data_size
			= sizeof(pm8058_laser2_leds_data);
...
#define DTH_GPIO_NUM  67

static struct gpio_switch_platform_data dth_switch_data = {
	.name		= "dock",
	.gpio		= DTH_GPIO_NUM,
};

static struct platform_device dth_switch = {
	.name		= "dock",
	.id		= -1,
	.dev		= {
		.platform_data = &dth_switch_data,
	},
};
...
#ifdef	CONFIG_SENSOR_I2C_GPIO
static void __init sensor_setup(void)
{
	// COMPASS_RES
	int i, rtn;
	struct vreg *vreg_sensor_26;
	struct vreg *vreg_sensor_18;
	struct vreg *vreg_ps_30;

	
	printk(KERN_ERR "%s: start======================sensor_init() \n",
		       __func__);
#if 1
	for (i = 0; i < ARRAY_SIZE(sensor_gpio_table); ++i)
	{
		 rtn = gpio_tlmm_config(sensor_gpio_table[i], GPIO_CFG_ENABLE);
		 if ( rtn ) {
			  printk(KERN_ERR "%s: Failed to sensor_gpio_table i2c gpio_tlmm_config(%d)=%d\r\n", __func__, i, rtn);
		 }
	}
#endif
	gpio_set_value(GPIO_M_GMS_RESET_N, 1);
	gpio_set_value(GPIO_M_GMS_INT_GPO, 0);

	vreg_sensor_26 = vreg_get(NULL, "gp4"); 
	rtn = vreg_set_level(vreg_sensor_26, 2600);
	if ( rtn ) {
		printk(KERN_ERR "%s: vreg gp4 set level failed (%d)\n", __func__, rtn);
		return;
	}
	vreg_enable(vreg_sensor_26);

	vreg_sensor_18 = vreg_get(NULL, "lvsw1");
	rtn = vreg_set_level(vreg_sensor_18, 1800);
	if ( rtn ) {
		printk(KERN_ERR "%s: vreg lvsw1 set level failed (%d)\n", __func__, rtn);
		return;
	}
	vreg_enable(vreg_sensor_18);
	
	vreg_ps_30 = vreg_get(NULL, "gp2");
	rtn = vreg_set_level(vreg_ps_30, 3000);
	if ( rtn ) {
		printk(KERN_ERR "%s: vreg gp2 set level failed (%d)\n", __func__, rtn);
		return;
	}

	/*MASAI proximity ws10 board SMT error, so gp2 disable*/	
#if defined(CONFIG_MACH_MSM8X55_J_MASAI_E)
	#if (BOARD_VER == WS10)
		vreg_disable(vreg_ps_30);
	#else
	...
	printk(KERN_ERR "%s: end======================sensor_init() \n",
		       __func__);
...
static void __init msm7x30_init(void)
{
  ...
  #if defined(T_LASER2)
  oem_smem_id_vendor1_type * vendor1_data;
  #endif
...
#ifdef CONFIG_PANTECH_MINI_HDRADIO
    if(machine_is_msm8x55_mini())
		spi_register_board_info(radio_siport_sp20xx_spi_board_info,
			ARRAY_SIZE(radio_siport_sp20xx_spi_board_info));
#endif
#endif
...
//by jhsong for fab2200 subsystem at 20110126
#ifndef CONFIG_SND_FAB_SUBSYSTEM
...
#ifndef CONFIG_MACH_MSM8X55_LASER2 /* Do. layer1 for VREG_L2 control */
...
//by jhsong for fab2200 subsystem at 20110126
#ifdef CONFIG_SND_FAB_SUBSYSTEM
        i2c_register_board_info(5, msm_audio_i2c_board_info,
	 		ARRAY_SIZE(msm_audio_i2c_board_info));
#endif/*CONFIG_SND_FAB_SUBSYSTEM*/

#if defined(CONFIG_MACH_MSM8X55_LASER2) && (BOARD_VER == WS10)
	i2c_register_board_info(15, i2c_touch_devices,
				ARRAY_SIZE(i2c_touch_devices));
#endif

#if defined(CONFIG_PANTECH_MINI_AUDIO_AUDIENCE1028)
	i2c_register_board_info(14 , i2c_audience_nr, ARRAY_SIZE(i2c_audience_nr)); 
	snd_audience_a1028_api_Init();
#elif defined(CONFIG_PANTECH_LASER2_AUDIENCE2020)
	i2c_register_board_info(14 , i2c_audience_nr, ARRAY_SIZE(i2c_audience_nr)); 
	...
	sensor_setup();
{
	...
	ret = i2c_register_board_info(10, m_sensor_board_info,
				ARRAY_SIZE(m_sensor_board_info));
	if (0 !=ret)  {
		printk(KERN_INFO "%s: 1 Could not register msm_ect_board_info ^^~~~ %d \n", __func__, ret);
	}
	
	ret = i2c_register_board_info(11 , g_sensor_board_info,
				ARRAY_SIZE(g_sensor_board_info));
	if (0 !=ret)  {
		printk(KERN_INFO "%s: 2 Could not register msm_ect_board_info ^^~~~ %d \n", __func__, ret);
	}	
	
	ret = i2c_register_board_info(12 , p_sensor_board_info,
				ARRAY_SIZE(p_sensor_board_info));
	if (0 !=ret)  {
		printk(KERN_INFO "%s: 3 Could not register msm_ect_board_info ^^~~~ %d \n", __func__, ret);
	}
  ...
  if (machine_is_msm8x55_j_masai_e())
		platform_device_register(&dth_switch);
  ...
  #if defined(T_LASER2)
  vendor1_data = (oem_smem_id_vendor1_type *)(smem_get_entry(SMEM_ID_VENDOR1, &smem_size));
  printk(KERN_NOTICE "HW REVISION = %s\n", vendor1_data->hardware_revision);
  #endif
}
...
MACHINE_START(MSM8X55_MINI, "PANTECH MSM8X55 MINI")
#ifdef CONFIG_MSM_DEBUG_UART
      .phys_io  = MSM_DEBUG_UART_PHYS,
      .io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
...
MACHINE_START(MSM8X55_J_MASAI_E, "PANTECH MSM8X55 J_MASAI_E")
#ifdef CONFIG_MSM_DEBUG_UART
      .phys_io  = MSM_DEBUG_UART_PHYS,
      .io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
...
MACHINE_START(MSM8X55_LASER2, "PANTECH MSM8X55 LASER2")
#ifdef CONFIG_MSM_DEBUG_UART
      .phys_io  = MSM_DEBUG_UART_PHYS,
      .io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
