...
#define CONFIG_QUALCOMM_00530837
#define CONFIG_QUALCOMM_00544265
...
#ifdef CONFIG_QUALCOMM_00530837
...
#endif
#ifndef CONFIG_QUALCOMM_00530837
...
#ifdef CONFIG_QUALCOMM_00544265
	if (!xprt_info) {
		return -ENETRESET;
	}
#endif
		   ...
		   unsigned len, long timeout)
{
	...
	unsigned long flags;
	int rc;
#ifndef CONFIG_QUALCOMM_00544265
	IO("READ on ept %p\n", ept);
#endif
	spin_lock_irqsave(&ept->restart_lock, flags);
	if (ept->restart_state !=  RESTART_NORMAL) {
