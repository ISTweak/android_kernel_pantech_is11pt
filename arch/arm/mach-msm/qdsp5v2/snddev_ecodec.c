...
static int is_pamp_on = 0;  //20110627 jhsong
#endif
...
#if defined(CONFIG_PANTECH_MINI_AUDIO_AUDIENCE1028) || defined(CONFIG_PANTECH_LASER2_AUDIENCE2020)
	/* audience enable */
//	if ((ecodec->data->pamp_on) && (!drv->tx_active))
	if ((ecodec->data->pamp_on) && (!is_pamp_on)){		//20110627 jhsong
		ecodec->data->pamp_on();
		is_pamp_on = 1;
	}
#endif	
...
#if defined(CONFIG_PANTECH_MINI_AUDIO_AUDIENCE1028) || defined(CONFIG_PANTECH_LASER2_AUDIENCE2020)
	/* audience disable */
//	if (ecodec->data->pamp_off && (!drv->tx_active))
	if (ecodec->data->pamp_off && (is_pamp_on)){		//20110627 jhsong
...
#if defined(CONFIG_PANTECH_MINI_AUDIO_AUDIENCE1028) || defined(CONFIG_PANTECH_LASER2_AUDIENCE2020)
	/* audience enable */
//	if (ecodec->data->pamp_on && (!drv->rx_active))
	if ((ecodec->data->pamp_on) && (!is_pamp_on)){		//20110627 jhsong
		ecodec->data->pamp_on();
		is_pamp_on = 1;
	}
...
static int snddev_ecodec_close_tx(struct snddev_ecodec_state *ecodec)
{
	...
	/* audience disable */
//	if (ecodec->data->pamp_off && (!drv->rx_active))
	if (ecodec->data->pamp_off && (is_pamp_on)){		//20110627 jhsong
		ecodec->data->pamp_off();
		is_pamp_on = 0;
	}
