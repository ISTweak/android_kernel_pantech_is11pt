...
#ifdef CONFIG_PANTECH_LASER2_AUDIENCE2020
	.pamp_on = &msm_snddev_nr_out_sel_qtrReceiver_or_A2020Speaker,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
	.pamp_off = &msm_snddev_nr_out_sel_A2020Reciever,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif	
...
static struct snddev_icodec_data snddev_i_nr_off_ct_rx_data = {
	...
	.default_sample_rate = 48000,
	.pamp_on = &msm_snddev_nr_out_sel_qtrReceiver_or_A2020Speaker,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
	.pamp_off = &msm_snddev_nr_out_sel_A2020Reciever,  // default switch statue by H/W recommand  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
	.property = SIDE_TONE_MASK,        
	.max_voice_rx_vol[VOC_NB_INDEX] = -200,
	.min_voice_rx_vol[VOC_NB_INDEX] = -1700,
	.max_voice_rx_vol[VOC_WB_INDEX] = -200,
...
static struct snddev_ecodec_data snddev_nr_ct_rx_data = {
	...
	.min_voice_rx_vol[VOC_WB_INDEX] = -1100,
#ifdef CONFIG_PANTECH_LASER2_AUDIENCE2020
	.pamp_on = &audience_a2020_ct_on,    //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
	.pamp_off = &audience_a2020_ct_off,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
#endif		
};
...
static struct snddev_ecodec_data snddev_nr_ft_rx_data = {
	...
	.min_voice_rx_vol[VOC_WB_INDEX] = -1100,
#ifdef CONFIG_PANTECH_LASER2_AUDIENCE2020
	.pamp_on = &audience_a2020_ft_on,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
	.pamp_off = &audience_a2020_off,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
#endif		
};
...
static struct snddev_ecodec_data snddev_nr_dv_rx_data = {
	...
	.min_voice_rx_vol[VOC_WB_INDEX] = -1100,
#ifdef CONFIG_PANTECH_LASER2_AUDIENCE2020
	.pamp_on = &audience_a2020_dv_on,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
	.pamp_off = &audience_a2020_off,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
#endif		
};
...
#if 0//ndef CONFIG_PANTECH_LASER2_AUDIENCE2020
...
static struct snddev_ecodec_data snddev_bt_sco_c_earpiece_data = {
	...
	.max_voice_rx_vol[VOC_WB_INDEX] = 400,
	.min_voice_rx_vol[VOC_WB_INDEX] = -1100,
#ifdef CONFIG_PANTECH_LASER2_AUDIENCE2020  // jmlee
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif	
};
...
static struct snddev_ecodec_data snddev_nr_ct_2mic_tx_data = {
	...
	.pamp_on = &audience_a2020_ct_2mic_on,  //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
	.pamp_off = &audience_a2020_ct_off, //20110301 jhsong : abnormal work after set path.....cause by pointer address so add "&" before func
#endif		
};
...
static struct snddev_icodec_data snddev_ispeaker_tx_data = {
	...
	.pamp_off = NULL,
#else
#ifndef CONFIG_PANTECH_AUDIO_FAB2200
	.pamp_on = msm_snddev_tx_route_config,
	.pamp_off = msm_snddev_tx_route_deconfig,
#endif
#endif	
...
void __ref msm_snddev_init(void)
{
	if (machine_is_msm7x30_ffa() || machine_is_msm8x55_ffa() ||
		...
		machine_is_msm8x55_svlte_surf() || machine_is_msm8x55_laser2() )
