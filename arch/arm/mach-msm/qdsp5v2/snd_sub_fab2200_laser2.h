...
#define DEVICE_SND_DEVICE_NR_CT_TX 		19  // Close talk TX
#define DEVICE_SND_DEVICE_NR_FT_TX 		20  // Far talk(speaker phone) TX
#define DEVICE_SND_DEVICE_NR_DV_TX 		21  // desk TX
#define DEVICE_SND_DEVICE_NR_CT_RX 		22  // Close talk RX
#define DEVICE_SND_DEVICE_NR_FT_RX 		23  // Far talk(speaker phone) RX
#define DEVICE_SND_DEVICE_NR_DV_RX 		24  // desk RX
#define DEVICE_SND_DEVICE_NR_OFF_CT_TX 	25  // Close talk TX
#define DEVICE_SND_DEVICE_NR_OFF_FT_TX 	26  // Far talk(speaker phone) TX
#define DEVICE_SND_DEVICE_NR_OFF_DV_TX 	27  // desk TX
#define DEVICE_SND_DEVICE_NR_OFF_CT_RX 	28  // Close talk RX
#define DEVICE_SND_DEVICE_NR_OFF_FT_RX 	29  // Far talk(speaker phone) RX
#define DEVICE_SND_DEVICE_NR_OFF_DV_RX 	30  // desk RX
#endif
