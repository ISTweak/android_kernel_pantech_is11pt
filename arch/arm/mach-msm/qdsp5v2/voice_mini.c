...
static struct device_vol_table_t device_vol_table[ACDB_ID_MAX] = {
...
#if 1 //20110602 jhsong : audio cal
        .level[0] = -2000,
        .level[1] = -1700,
        .level[2] = -1400,
        .level[3] = -1100,
    ...
    [ACDB_ID_BT_SCO_SPKR] = {
#if 1 //20110627 jhsong : audio cal
        .level[0] = -400,
        .level[1] = -400,
        .level[2] = -400,
        .level[3] = -400,
    ...
    [ACDB_ID_NR_CT_RX] = {
#if 1 //20110701 jhsong : audio cal
        .level[0] = -1200,
        .level[1] = -800,
        .level[2] = -400,
        .level[3] = 0,
    ...
    [ACDB_ID_NR_FT_RX] = {
#if 1 //20110531 jhsong : audio cal
        .level[0] = -900,
        .level[1] = -600,
        .level[2] = -300,
        .level[3] =  0,
...
#if 1 //20110411 jhsong : audio cal
        .level[0] = -1000,
        .level[1] = -700,
        .level[2] = -400,
        .level[3] = -100,
...
#endif //CONFIG_PANTECH_MINI_AUDIO_AUDIENCE1028
