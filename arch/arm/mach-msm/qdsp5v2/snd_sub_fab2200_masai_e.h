...
#define GPIO_SUBSYSTEM_ENABLE		165
...
#define DEVICE_SND_DEVICE_VOICE_SPEAKER_RX  19  // VOICE Speaker RX
#define DEVICE_SND_DEVICE_VOICE_SPEAKER_TX  20  // VOICE Speaker TX
#define DEVICE_SND_DEVICE_VOICE_HEADSET_RX  21  // VOICE HEadset RX
#define DEVICE_SND_DEVICE_VOICE_HEADSET_TX  22  // VOICE HEadset TX
#endif
...
void snd_subsystem_hp_setVolume(void);
