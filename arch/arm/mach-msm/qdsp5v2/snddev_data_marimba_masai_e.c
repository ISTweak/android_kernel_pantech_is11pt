...
#include <mach/qdsp5v2/audio_acdb_def_masai_e.h>
...
static struct adie_codec_action_unit testcode_handset_earpiece_48KHz_osr256_actions[] =
	TESTCODE_HANDSET_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry testcode_handset_earpiece_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = testcode_handset_earpiece_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(testcode_handset_earpiece_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile testcode_handset_earpiece_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = testcode_handset_earpiece_settings,
	.setting_sz = ARRAY_SIZE(testcode_handset_earpiece_settings),
};

static struct snddev_icodec_data snddev_testcode_handset_earpiece_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "testcode_handset_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR,
	.profile = &testcode_handset_earpiece_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_testcode_handset_rx_device = {
	.name = "snddev_icodec",
	.id = 40,
	.dev = { .platform_data = &snddev_testcode_handset_earpiece_data },
};


static struct adie_codec_action_unit testcode_handset_mic_48KHz_osr256_actions[] =
	TESTCODE_HANDSET_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry testcode_handset_mic_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = testcode_handset_mic_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(testcode_handset_mic_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile testcode_handset_mic_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = testcode_handset_mic_settings,
	.setting_sz = ARRAY_SIZE(testcode_handset_mic_settings),
};

static struct snddev_icodec_data snddev_testcode_handset_mic_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "testcode_headset_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_MIC,
	.profile = &testcode_handset_mic_profile,
	.channel_mode = 1,
	.pmctl_id = imic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(imic_pmctl_id),
	.default_sample_rate = 48000,
...
static struct platform_device msm_testcode_handset_tx_device = {
	.name = "snddev_icodec",
	.id = 39,
	.dev = { .platform_data = &snddev_testcode_handset_mic_data },
};
#endif
...
static struct snddev_icodec_data snddev_ihs_stereo_rx_data = {
	...
	// 110530 YSLEEM ### Separate Setting HP Volume of FAB2200(MIRACH_J Only)
#ifdef CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL
	.pamp_postProc = &snd_subsystem_hp_poweron_postProc,
#endif /* CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL */
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif
...
#ifdef CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL
	.pamp_postProc = &snd_subsystem_hp_poweron_postProc,
#endif /* END of CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL */
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif
...
static struct adie_codec_action_unit ihs_voice_stereo_rx_48KHz_osr256_actions[] =
	HEADSET_VOICE_STEREO_RX_LEGACY_48000_OSR_256;

static struct adie_codec_hwsetting_entry ihs_voice_stereo_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihs_voice_stereo_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_voice_stereo_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ihs_voice_stereo_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ihs_voice_stereo_rx_settings,
	.setting_sz = ARRAY_SIZE(ihs_voice_stereo_rx_settings),
};

static struct snddev_icodec_data snddev_voice_headset_stereo_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "voice_headset_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_VOICE_HEADSET_RX,
	.profile = &ihs_voice_stereo_rx_profile,
	.channel_mode = 2,
	.default_sample_rate = 48000,
#ifdef CONFIG_PANTECH_AUDIO_FAB2200    //20110428 jhsong : feature clearup
	.pamp_on = &snd_subsystem_voice_hp_poweron,
	.pamp_off = &snd_subsystem_voice_hp_powerdown,
	// 110530 YSLEEM ### Separate Setting HP Volume of FAB2200(MIRACH_J Only)
#ifdef CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL
	.pamp_postProc = &snd_subsystem_voice_hp_poweron_postProc,
#endif /* END of CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL */
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
...
static struct platform_device msm_voice_headset_rx_device = {
	.name = "snddev_icodec",
	.id = 37,
	.dev = { .platform_data = &snddev_voice_headset_stereo_rx_data },
};


static struct adie_codec_action_unit ihs_voice_mono_tx_48KHz_osr256_actions[] =
	HEADSET_VOICE_MONO_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry ihs_voice_mono_tx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihs_voice_mono_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_voice_mono_tx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ihs_voice_mono_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = ihs_voice_mono_tx_settings,
	.setting_sz = ARRAY_SIZE(ihs_voice_mono_tx_settings),
};

static struct snddev_icodec_data snddev_ihs_voice_mono_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "voice_headset_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_VOICE_HEADSET_TX,
	.profile = &ihs_voice_mono_tx_profile,
	.channel_mode = 1,
#ifdef CONFIG_PANTECH_AUDIO_FAB2200    //20110428 jhsong : feature clearup
	.pmctl_id = i_hs_mono_tx_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(i_hs_mono_tx_pmctl_id),
...
static struct platform_device msm_voice_headset_tx_device = {
	.name = "snddev_icodec",
	.id = 38,
	.dev = { .platform_data = &snddev_ihs_voice_mono_tx_data },
};
...
static struct snddev_icodec_data snddev_ispeaker_rx_data = {
	...
	// 110530 YSLEEM ### Separate Setting HP Volume of FAB2200(MIRACH_J Only)
#ifdef CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL
	.pamp_postProc = &snd_subsystem_sp_poweron_postProc,
#endif /* END of CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL */
#else
...
#ifdef CONFIG_PANTECH_MASAI_E_SEPERATE_CALL_MEDIA_PATH  //20110420 jhsong : seperate call and media path
static struct adie_codec_action_unit ispeaker_voice_rx_48KHz_osr256_actions[] =
   SPEAKER_VOICE_STEREO_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry ispeaker_voice_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispeaker_voice_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispeaker_voice_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispeaker_voice_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispeaker_voice_rx_settings,
	.setting_sz = ARRAY_SIZE(ispeaker_voice_rx_settings),
};

static struct snddev_icodec_data snddev_ispeaker_voice_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "voice_speaker_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_VOICE_SPEAKER_RX,
	.profile = &ispeaker_voice_rx_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
#ifdef CONFIG_PANTECH_AUDIO_FAB2200    //20110428 jhsong : feature clearup
	.pamp_on = &snd_subsystem_voice_sp_poweron,
	.pamp_off = &snd_subsystem_voice_sp_powerdown,
	// 110530 YSLEEM ### Separate Setting HP Volume of FAB2200(MIRACH_J Only)
#ifdef CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL
	.pamp_postProc = NULL,
#endif /* END of CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL */
...
static struct platform_device msm_voice_speaker_rx_device = {
	.name = "snddev_icodec",
	.id = 35,
	.dev = { .platform_data = &snddev_ispeaker_voice_rx_data },

};


static struct adie_codec_action_unit ispeaker_voice_tx_48KHz_osr256_actions[] =
	SPEAKER_VOICE_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry ispeaker_voice_tx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispeaker_voice_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispeaker_voice_tx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispeaker_voice_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = ispeaker_voice_tx_settings,
	.setting_sz = ARRAY_SIZE(ispeaker_voice_tx_settings),
};

static struct snddev_icodec_data snddev_ispeaker_voice_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "voice_speaker_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_VOICE_SPEAKER_TX,
	.profile = &ispeaker_voice_tx_profile,
	.channel_mode = 1,
	.pmctl_id = ispk_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(ispk_pmctl_id),
	.default_sample_rate = 48000,
...
static struct platform_device msm_voice_speaker_tx_device = {
	.name = "snddev_icodec",
	.id = 36,
	.dev = { .platform_data = &snddev_ispeaker_voice_tx_data },
};
#endif
...
static struct snddev_icodec_data snddev_ihs_stereo_speaker_stereo_rx_data = {
	...
	// 110530 YSLEEM ### Separate Setting HP Volume of FAB2200(MIRACH_J Only)
#ifdef CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL
	.pamp_postProc = &snd_subsystem_sp_hp_poweron,
#endif /* END of CONFIG_PANTECH_AUDIO_FAB2200_SEPARATE_HPVOLUME_CTRL */
#else
	.pamp_on = msm_snddev_poweramp_on,
	.pamp_off = msm_snddev_poweramp_off,
...
#endif
#ifdef CONFIG_PANTECH_MASAI_E_SEPERATE_CALL_MEDIA_PATH  //20110420 jhsong : seperate call and media path
	&msm_voice_speaker_rx_device,
	&msm_voice_speaker_tx_device,
	&msm_voice_headset_rx_device,
	&msm_voice_headset_tx_device,
#endif
#ifdef CONFIG_PANTECH_TEST_CODE_PATH  //20110711 jhsong
	&msm_testcode_handset_rx_device,
	&msm_testcode_handset_tx_device,
#endif
};
