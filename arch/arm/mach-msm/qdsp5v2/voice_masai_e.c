...
#ifdef CONFIG_PANTECH_MIRACHJ_RXMUTE
#define MAX_DEVVOL_LV   7  // 110617 YSLEEM ## Rx Mute
#else
...
//[0518] jhsong : audio cal
        ...
        .level[5] = 400,
#ifdef CONFIG_PANTECH_MIRACHJ_RXMUTE
        .level[6] = -5000,  // 110617 YSLEEM ## Rx Mute 
#endif
    },
...
#ifdef CONFIG_PANTECH_MASAI_E_SEPERATE_CALL_MEDIA_PATH
    [ACDB_ID_VOICE_SPEAKER_RX] = {
        .level[0] = -500,
        .level[1] = -200,
        .level[2] =   100,
        .level[3] =   400,
...
#ifdef CONFIG_PANTECH_AUDIO_RX_VOLUME   //20110428 jhsong : feature clearup
#ifdef CONFIG_PANTECH_MIRACHJ_RXMUTE
    int level_table[MAX_DEVVOL_LV] = {0, 20, 40, 60, 80, 100, 200};
#else
