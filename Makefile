...
PANTECH_ANDROID_FLAGS := -DFEATURE_AARM_RELEASE_MODE -DT_J_MASAI_E
PANTECH_ANRDOID_FLAGS += -Ipantech/include 
PANTECH_ANDROID_FLAGS += -include pantech/include/CUST_PANTECH.h
PANTECH_ANDROID_FLAGS += -DSYS_MODEL_NAME=\"J_MASAI_E\" -DOEM_PRODUCT_DEVICE=\"mirachj\"
