...
#define MT9P111_TUP_REG_BURST_MARK					"REG_BURST="
#define MT9P111_TUP_OTP_MODULE_ZONE_DETECT_MARK		"OTP_MODULE_ZONE_DETECT"

#define MT9P111_TUP_BURST_MODE_MAX_PARAMS    2048
#define MT9P111_TUP_INIT_MAX_PARAMS      	(4096 + MT9P111_TUP_BURST_MODE_MAX_PARAMS)
...
#define FALSE 0
 ...
 typedef enum {
	 MT9P111_CFG_WB_AUTO,
	 MT9P111_CFG_WB_CUSTOM, 	 /*not use (auto mode setting)*/
...
typedef enum
{
 ...
 typedef enum {          // <addr>           <data>
    ...
    CAMOP_REG_BURST_MODE,
    CAMOP_REG_OTP_MODULE_ZONE_DETECT_MODE,                    
    CAMOP_MAX
} mt9p111_cfg_op_e;
