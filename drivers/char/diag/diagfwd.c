...
#define FEATURE_ANDROID_PANTECH_QXDM_RESET_FIX 

#ifdef CONFIG_PANTECH_SKY_FACTORY_COMMAND //msy_sky_factory_command
/*  Sub Command 	*/
enum
{
...
FACTORY_PATTERN_UNLOCK_I    = 0xE7, // PATTERN Aa¡¾Y ¨ù©øA¢´ C¨ªA|
...
#ifdef FEATURE_ANDROID_PANTECH_QXDM_RESET_FIX 
	else if (*buf == 0x02){ 
		driver->apps_rsp_buf[0] = 0x13; /* Invalid Packet Response Command */
		driver->apps_rsp_buf[1] = 0x02;
