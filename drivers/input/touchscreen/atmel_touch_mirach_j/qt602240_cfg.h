...
#define T8_CHRGTIME                           9//10
#define T8_ATCHDRIFT                          0	
#define T8_TCHDRIFT                            5	//7
#define T8_DRIFTST                              5	
#define T8_TCHAUTOCAL                      0
#define T8_SYNC                                   0
#define T8_ATCHCALST                         9
#define T8_ATCHCALSTHR                    30	//0
#if defined(__VER_2_0__)
#define T8_ATCHFRCCALTHR                0	//50         /* V2.0 추가 */
#define T8_ATCHFRCCALRATIO            0	//25         /* V2.0 추가 */
#endif
...
#define T9_XRANGE                                  800    // 898 = (97.65/87.1) * 800    
...
#define T22_FREQ_0                              12
#define T22_FREQ_1                              21
#define T22_FREQ_2                              26
#define T22_FREQ_3                              36
#define T22_FREQ_4                              56
