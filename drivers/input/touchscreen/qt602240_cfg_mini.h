...
#define TOUCH_MENU_MIN		27
#define TOUCH_MENU_MAX		119
#define TOUCH_BACK_MIN		361
#define TOUCH_BACK_MAX		453
...
#define T9_XORIGIN                      0
#define T9_YORIGIN                      0
#define T9_XSIZE                        17/*19*/
#define T9_YSIZE                        13/*11*/
#define T9_AKSCFG                       0
#define T9_BLEN                         0x20//17
#define T9_TCHTHR                       42//50
#define T9_TCHTHR_E                     55//75//50//80//70//50
