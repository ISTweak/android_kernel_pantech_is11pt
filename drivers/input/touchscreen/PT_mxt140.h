...
{ 
   ...
   uint8_t atchfrccalthr;     /*!< Ver2.0 Added/ Anti-touch force calibration threshold */
   int8_t  atchfrccalration ;  /*!< Ver2.0 Added/ Anti-touch force calibration ratio */  
...
typedef struct
{
  ...
  uint8_t tchhyst;       /* Ver2.0 added / Touch threshold hysteresis */
