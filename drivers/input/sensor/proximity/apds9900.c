...
#define APDS9900_THRESHOLD_LOW			23
#elif (BOARD_VER == WS10 )
#define APDS9900_THRESHOLD_HIGH			41
#define APDS9900_THRESHOLD_LOW			23
#elif (BOARD_VER >= WS20 )
#define APDS9900_THRESHOLD_HIGH			41
#define APDS9900_THRESHOLD_LOW			24
#endif
#elif defined(CONFIG_MACH_MSM8X55_J_MASAI_E)
#if (BOARD_VER >= WS20 )
#define APDS9900_THRESHOLD_HIGH			56
//#define APDS9900_THRESHOLD_LOW			34
#define APDS9900_THRESHOLD_LOW			47
#else
#define APDS9900_THRESHOLD_HIGH			41
#define APDS9900_THRESHOLD_LOW			23
#endif
#elif defined(CONFIG_MACH_MSM8X55_LASER2)
#define APDS9900_THRESHOLD_HIGH			16
#define APDS9900_THRESHOLD_LOW			12
#endif
...
//#define POWER_ON_OFF
#define PS_FAST_MODE /*calling, to fast LCD wakeup*/
...
static int apds9900_set_thrconfig(u16 thrh, u16 thrl)
{
	...
	if(apds9900data.active > 0) {
		//ret |= apds9900_set_reg(APDS9900_ENABLE_REG, 0x03);
		enable |= 0x03;
	}
	...
	#else
	ret |= apds9900_set_reg(APDS9900_PERS_REG, 0x11);
	#endif
	#else
...
static int __devinit apds9900_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	gpioConfig = GPIO_CFG(APDS9900_PS_INT_N, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_PULL_UP);
