...
#define ACCELEROMETER_POSITION 2
#elif defined(CONFIG_MACH_MSM8X55_J_MASAI_E)
#define ACCELEROMETER_POSITION 3
#elif defined(CONFIG_MACH_MSM8X55_LASER2)
#define ACCELEROMETER_POSITION 0
#endif
...
#ifdef POWER_ON_OFF
extern void geomagnetic_set_power(bool on);
#endif
...
static int yas_acc_core_driver_init(struct yas_acc_private_data *data)
{
    ...
    err = driver->set_position(ACCELEROMETER_POSITION);
    if (err != YAS_NO_ERROR) {
        kfree(driver);
        return err;
    }
